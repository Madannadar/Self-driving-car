...
const traffic = [
    // new Car(road.getLaneCenter(3), -10, 30, 50, "DUMMY", 2), 
...
function animate(time){
    ...
    requestAnimationFrame(animate); // this calls the animate function again and again which gives the view of a animation being done 
}